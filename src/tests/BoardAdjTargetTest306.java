...
public class BoardAdjTargetTest306 {
	...
	public void testAdjacenciesRooms()
	{
		...
		testList = board.getAdjList(board.getCell(20,11));
		assertEquals(4, testList.size());
		assertTrue(testList.contains(board.getCell(16, 9)));
		
		// one more room, the kitchen
		testList = board.getAdjList(board.getCell(20,19));
		assertEquals(2, testList.size());
	...
	{
		Set<BoardCell> testList = board.getAdjList(board.getCell(11,1));
		assertEquals(2, testList.size());
		assertTrue(testList.contains(board.getCell(14, 2)));
		assertTrue(testList.contains(board.getCell(11, 2)));

		testList = board.getAdjList(board.getCell(19,5));
		...
		testList = board.getAdjList(board.getCell(19,7));
		assertEquals(4, testList.size());
	...
	public void testAdjacencyWalkways()
	{
		...
		Set<BoardCell> testList = board.getAdjList(board.getCell(24,14));
		assertEquals(1, testList.size());
		assertTrue(testList.contains(board.getCell(23, 14)));
		
		// Test near a door but not adjacent
		testList = board.getAdjList(board.getCell(18,4));
		assertEquals(3, testList.size());
		...
		testList = board.getAdjList(board.getCell(19,6));
		assertEquals(4, testList.size());
		...
		// Test next to closet
		testList = board.getAdjList(board.getCell(9,14));
		assertEquals(3, testList.size());
